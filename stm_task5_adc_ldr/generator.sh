...
########################################################################
# generator.sh for STM32 task5 led controlled via adc and timer
...
cp ${task_path}/static/adc_ldr.c ${desc_path}
...
##########################
task_attachments=""
task_attachments_base="${desc_path}/desc_${user_id}_Task${task_nr}.pdf ${desc_path}/adc_ldr.c"
