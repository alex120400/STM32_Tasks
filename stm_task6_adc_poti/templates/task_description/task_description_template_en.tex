...
Please note that if the potentiometer is turned too far, voltages above 3.3\,V and up to 5\,V may be present. This will destroy the pin. Therefore, ensure that you do not turn the potentiometer too far. Refer to the initial position for 0\,V shown in Figure~xy and implement your firmware accordingly. Once the firmware works and you begin receiving measurement values via a serial terminal such as HTerm, you may slowly adjust the potentiometer.\\
