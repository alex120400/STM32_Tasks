...
Beachten Sie, dass bei zu weitem Drehen des Potentiometers Spannungen über 3.3\,V bis zu 5\,V anliegen. Dies zerstört den Pin. Achten Sie daher darauf das Potentiometer nicht zu weit zu drehen. Beachten Sie hierzu die Anfangsstellung für 0\,V in Abbildung \ref{fig:poti_0V} und implementieren Sie Ihre Firmware. Sobald diese funktioniert und Sie Messwerte über einen seriellen Terminal wie zB HTerm empfangen, können sie das Potentiometer langsam verdrehen.\\

\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{poti_0V.jpg}
    \caption{Potentiometer in der 0\,V Position. Beachten Sie, dass das Potentiometer sich in dieser Position nicht weiter gegen den Uhrzeigersinn drehen lassen sollte. Drehen im Uhrzeigersinn erhöht die gemessene Spannung.}
    \label{fig:poti_0V}
\end{figure}
