...
########################################################################
# generator.sh for STM32 task6 uart controlled via adc and timer
...
cp ${task_path}/static/adc_poti.c ${desc_path}
...
##########################
task_attachments=""
task_attachments_base="${desc_path}/desc_${user_id}_Task${task_nr}.pdf ${desc_path}/adc_poti.c"
