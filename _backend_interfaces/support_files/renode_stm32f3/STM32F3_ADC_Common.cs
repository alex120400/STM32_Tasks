...
namespace Antmicro.Renode.Peripherals.Analog
{
    ...
    public abstract class STM32F3_ADC_Common : IKnownSize, IProvidesRegisterCollection<DoubleWordRegisterCollection>, IDoubleWordPeripheral
    {
        public STM32F3_ADC_Common(IMachine machine, double referenceVoltage, uint externalEventFrequency, int dmaChannel = 0, IDMA dmaPeripheral = null,
        ...
        private void StartSampling()
        {
            ...
            else
            {
                ...
                this.Log(LogLevel.Debug, "About to sample channel {0}", currentChannel);
            }
            this.Log(LogLevel.Debug, "Sampling Sequence started!");
        ...
        private void SampleNextChannel()
        {
            ...
            while(!iterationFinished() && currentChannel >= 0)
            {
                ...
                else
                {
                    ...
                    UpdateInterrupts();
                    this.Log(LogLevel.Debug, "Finished Sampling channel {0}", currentChannel);
                    SwitchToNextChannel();
                    
                    // Auto-clear ADSTART for single conversion mode or more acurately single channel sequence (modes are not implemented)
                    if((int)regularSequenceLength.Value == 0) // regularSequenceLength being 0 means only 1 channel in sequence
                    {
                        this.Log(LogLevel.Debug, "Single conversion complete — clearing ADSTART");
        ...
        private uint GetSampleFromChannel(int channelNumber)
        {
            ...
            this.Log(LogLevel.Debug, "Got Sample {0} from channel", sample);
        ...
        private Dictionary<long, DoubleWordRegister> BuildRegistersMap(bool hasCalibration, bool hasPrescaler, bool hasVbatPin, bool hasChannelSequence, bool hasPowerRegister)
        {
                ...
                .WithFlag(2, out endOfConversionFlag, FieldMode.Read | FieldMode.WriteOneToClear,  writeCallback: (_, val) =>
                    {
                        if(val)
                        {
                            ...
                            if(((int)regularSequenceLength.Value > 0) && sequenceInProgress) // regularSequenceLength being > 0 means EOC clearance should trigger next channel conversion
                            {
                                this.Log(LogLevel.Debug, "About to sample channel {0}", currentChannel);
            ...
            var configurationRegister = new DoubleWordRegister(this)
            ...
            {                
                regularSequence1
                    .WithValueField(0, 4, out regularSequenceLength, name: "SL")
                    .WithReservedBits(4, 2)
                    .WithValueField(6, 5, out regularSequence[0], name: "SQ1")
                    .WithReservedBits(11, 1)
                    .WithValueField(12, 5, out regularSequence[1], name: "SQ2")
                    .WithReservedBits(17, 1)
                    .WithValueField(18, 5, out regularSequence[2], name: "SQ3")
                    .WithReservedBits(23, 1)
                    .WithValueField(24, 5, out regularSequence[3], name: "SQ4")
            ...
            var regularSequence2 = new DoubleWordRegister(this);

            if(hasChannelSequence)
            {                
                regularSequence2
                    .WithValueField(0, 5, out regularSequence[4], name: "SQ5")
                    .WithReservedBits(5, 1)
                    .WithValueField(6, 5, out regularSequence[5], name: "SQ6")
                    .WithReservedBits(11, 1)
                    .WithValueField(12, 5, out regularSequence[6], name: "SQ7")
                    .WithReservedBits(17, 1)
                    .WithValueField(18, 5, out regularSequence[7], name: "SQ8")
                    .WithReservedBits(23, 1)
                    .WithValueField(24, 5, out regularSequence[8], name: "SQ9")
                    .WithReservedBits(29, 3);
            }
            else
            {
            ...
            var regularSequence3 = new DoubleWordRegister(this);

            if(hasChannelSequence)
            {                
                regularSequence3
                    .WithValueField(0, 5, out regularSequence[9], name: "SQ10")
                    .WithReservedBits(5, 1)
                    .WithValueField(6, 5, out regularSequence[10], name: "SQ11")
                    .WithReservedBits(11, 1)
                    .WithValueField(12, 5, out regularSequence[11], name: "SQ12")
                    .WithReservedBits(17, 1)
                    .WithValueField(18, 5, out regularSequence[12], name: "SQ13")
                    .WithReservedBits(23, 1)
                    .WithValueField(24, 5, out regularSequence[13], name: "SQ14")
                    .WithReservedBits(29, 3);
            }
            else
            {
            ...
            var regularSequence4 = new DoubleWordRegister(this);

            if(hasChannelSequence)
            {                
                regularSequence4
                    .WithValueField(0, 5, out regularSequence[14], name: "SQ15")
                    .WithReservedBits(5, 1)
                    .WithValueField(6, 5, out regularSequence[15], name: "SQ16")
            ...
            var commonConfigurationRegister = new DoubleWordRegister(this)
                ...
                .WithValueField(16, 2, name: "CKMODE")
            ...
            var registers = new Dictionary<long, DoubleWordRegister>
            {
                ...
                {(long)Registers.Control, new DoubleWordRegister(this)
                    ...
                    .WithTaggedFlag("ADCAL", 31) // no logic implemented, but software expects to read this flag back
                },
                {(long)Registers.Configuration, configurationRegister},
                {(long)Registers.SamplingTime1, new DoubleWordRegister(this)
                ...
                {(long)Registers.SamplingTime2, new DoubleWordRegister(this)
                    .WithTag("SMP10", 0, 3)
                    .WithTag("SMP11", 3, 3)
                    .WithTag("SMP12", 6, 3)
                    .WithTag("SMP13", 9, 3)
                ...
                {(long)Registers.RegularSequence2, regularSequence2},
                {(long)Registers.RegularSequence3, regularSequence3},
                {(long)Registers.RegularSequence4, regularSequence4},
            ...
            if(WatchdogCount >= 2)
            {
                ...
                registers.Add((long)Registers.Watchdog2Configuration, new DoubleWordRegister(this)
                    ...
                    .WithFlags(1, 18, out analogWatchdog2SelectedChannels, name: "AWD2CH")
            ...
            if(WatchdogCount == 3)
            {
                ...
                registers.Add((long)Registers.Watchdog3Configuration, new DoubleWordRegister(this)
                    .WithReservedBits(0, 1)
                    .WithFlags(1, 18, out analogWatchdog3SelectedChannels, name: "AWD3CH")
                    .WithReservedBits(19, 13));
            }
        ...
        private const int MaximumSequenceLength = 18;
        ...
        private enum Registers
        {
            ...
            Control                = 0x08, // ADC_CR
            Configuration         = 0x0C, // ADC_CFGR1
            //Configuration2         = 0x10, // ADC_CFGR2
            SamplingTime1           = 0x14, // ADC_SMPR1
            ...
            Watchdog3Threshold     = 0x28, // ADC_AWD3TR
